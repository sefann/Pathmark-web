...
const Footer = () => {
  ...
  const socialLinks = [
    { name: 'LinkedIn', href: 'https://www.linkedin.com/company/pathmark-advisory-co-ltd/about/?viewAsMember=true', icon: Linkedin },
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm text-gray-300">+2347079993916</span>
              </div>
              <div className="flex items-center space-x-3">
