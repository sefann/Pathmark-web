...
export default function AboutPage() {
  ...
  const leadership = [
    ...
    },
    {
      ...
      bio: 'Accomplished entrepreneur, financial strategist, and business executive with more than 15 years of cross-industry experience driving strategic initiatives across project management, trading, finance, energy, agriculture, and logistics.',
      detailedBio: 'Sulaimon Ajishafe is an accomplished entrepreneur, financial strategist, and business executive with more than 15 years of cross-industry experience. As Executive Partner at Pathmark Advisory Co. Ltd., he plays a pivotal role in shaping the firm\'s strategic direction, drawing on expertise that spans project management, trading, finance, energy, agriculture, logistics. He also serves as Chairman of NewAge Group, where he has led transformative initiatives across import-export and agribusiness. With a B.Sc. in Accounting and Finance from the State University of New York and an early foundation in Computer Science at Brooklyn Technical High School, Sulaimon blends financial acumen with technical insight to help organizations navigate complex markets. Widely recognized as both a strategist and numbers-driven connector, he has consistently harnessed his financial acumen and business insight to align industries, unlock opportunities, and drive measurable, sustainable impact. Beyond business, Sulaimon is deeply committed to philanthropy, supporting initiatives that empower communities and foster inclusive development.',
      expertise: ['Project Management', 'Trading', 'Finance', 'Energy', 'Agriculture', 'Logistics', 'Strategic Planning', 'Business Development', 'Financial Strategy', 'Cross-Industry Advisory'],
      quote: 'Success is not just about individual achievements; it\'s about creating lasting impact that empowers communities and drives sustainable development.',
